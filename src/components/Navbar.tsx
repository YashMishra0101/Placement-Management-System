...
const Navbar = () => {
  ...
  if (currentUser?.role === "admin") {
    navLinks.push({ name: "Admin Dashboard", path: "/dashboard" });
  } else if (currentUser?.role === "recruiter") {
    navLinks.push({ name: "Recruiter Portal", path: "/recruiterjobpostpage" });
  } else if (currentUser?.role === "student") {
    navLinks.push({ name: "Job Listings", path: "/joblistingspage" });
  }
